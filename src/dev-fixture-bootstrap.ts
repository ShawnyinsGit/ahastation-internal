          ...
          delivery: {
            ...
            candidate: {
              ...
              frozen: {
                ...
                commit: 'e5f6a7b8',
                tree: 'f9e8d7c6',
                reportHash: 'hash-report-fixture',
                verificationHash: 'hash-verify-fixture',
                diffHash: 'hash-diff-fixture',
                reportedPaths: ['electron/worker-protocol.ts'],
                createdAt: now,
                manifest: {
                  schemaVersion: 1,
                  baseRevision: 'a1b2c3d4',
                  candidateRevision: 'e5f6a7b8',
                  diffHash: 'hash-diff-fixture',
                  files: [{
                    path: 'electron/worker-protocol.ts',
                    status: 'modified',
                    additions: 3,
                    deletions: 1,
                    oldMode: '100644',
                  ...
                  chunks: [{
                    ...
                    path: 'electron/worker-protocol.ts',
                    kind: 'text',
                    hash: 'hash-chunk-fixture',
                    lineCount: 12,
                    byteLength: 420,
                    content: [
                      'diff --git a/electron/worker-protocol.ts b/electron/worker-protocol.ts',
                      'index a1b2c3d..e5f6a7b 100644',
                      '--- a/electron/worker-protocol.ts',
                      '+++ b/electron/worker-protocol.ts',
                      '@@ -1,4 +1,6 @@',
