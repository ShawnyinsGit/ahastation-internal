...
export function FinalMeetingDelivery({
  ...
  return (
    <section className="final-meeting-delivery" aria-labelledby="final-meeting-delivery-title">
      ...
      {decision?.kind === 'accept' && <p role="status">最终交付已接受并发布。</p>}
        ...
        <footer>
          ...
          <label>
            ...
            <textarea
              ...
              placeholder="说明哪些结果需要调整；已集成提交不会被回滚。"
            />
          </label>
          <button
            type="button"
          ...
          <small>返工会创建新版本任务；已接受任务和集成提交保持终态、不会被重写。</small>
        </footer>
      )}
    </section>
  );
